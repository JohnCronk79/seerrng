...
test(
  'ignores unknown-platform provenance descriptors when verifying platforms',
  {
    skip:
      process.platform === 'win32'
        ? 'The fixture models Linux executable and OCI platform semantics; Linux CI runs this test.'
        : false,
  },
  () => {
