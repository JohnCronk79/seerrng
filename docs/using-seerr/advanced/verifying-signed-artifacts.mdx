...
- GitHub Container Registry (GHCR): `ghcr.io/snapetech/seerrng:<tag>`
- Docker Hub: `snapetech/seerrng:<tag>`

You can view all available tags on the [Seerr Releases page](https://github.com/snapetech/seerrng/releases).
...
```bash
docker buildx imagetools inspect ghcr.io/snapetech/seerrng:v0.1.0 --format '{{json .Manifest.Digest}}' | tr -d '"'
```
  </TabItem>
...
```bash
skopeo inspect docker://ghcr.io/snapetech/seerrng:v0.1.0 --format '{{.Digest}}'
```
  </TabItem>
</Tabs>
...
```bash
cosign verify ghcr.io/snapetech/seerrng@sha256:abcd1234... \
  --certificate-identity "https://github.com/snapetech/seerrng/.github/workflows/release.yml@refs/tags/v0.1.0" \
...
```bash
cosign verify snapetech/seerrng@sha256:abcd1234... \
  --certificate-identity "https://github.com/snapetech/seerrng/.github/workflows/release.yml@refs/tags/v0.1.0" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```
  </TabItem>
...
Verification for `ghcr.io/snapetech/seerrng@sha256:abcd1234...`
...
```bash
docker buildx imagetools inspect ghcr.io/snapetech/seerrng:latest --format '{{json .Manifest.Digest}}' | tr -d '"'
```
  </TabItem>
...
```bash
skopeo inspect docker://ghcr.io/snapetech/seerrng:latest --format '{{.Digest}}'
```
  </TabItem>
</Tabs>
...
```bash
cosign verify ghcr.io/snapetech/seerrng@sha256:abcd1234... \
  --certificate-identity-regexp "https://github.com/snapetech/seerrng/.github/workflows/release.yml@refs/tags/v.*" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```
  </TabItem>
...
```bash
cosign verify-attestation ghcr.io/snapetech/seerrng@sha256:abcd1234... \
  --type cyclonedx \
  --certificate-identity "https://github.com/snapetech/seerrng/.github/workflows/release.yml@refs/tags/v0.1.0" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```
...
```
https://github.com/snapetech/seerrng/.github/workflows/release.yml@refs/tags/v*
```

This confirms that the image was:

- Built by the official SeerrNG Release workflow
- Produced from the snapetech/seerrng repository
...
```bash
DIGEST=$(docker buildx imagetools inspect ghcr.io/snapetech/seerrng:latest --format '{{json .Manifest.Digest}}' | tr -d '"')

cosign verify ghcr.io/snapetech/seerrng@"$DIGEST" \
  --certificate-identity-regexp "https://github.com/snapetech/seerrng/.github/workflows/release.yml@refs/tags/v.*" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"

cosign verify-attestation ghcr.io/snapetech/seerrng@"$DIGEST" \
  --type cyclonedx \
  --certificate-identity-regexp "https://github.com/snapetech/seerrng/.github/workflows/release.yml@refs/tags/v.*" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```
...
```bash
DIGEST=$(skopeo inspect docker://ghcr.io/snapetech/seerrng:latest --format '{{.Digest}}')
...
- GitHub Container Registry (GHCR): `ghcr.io/snapetech/seerrng/seerr-chart:<tag>`

You can view all available tags on the [Seerr Releases page](https://github.com/snapetech/seerrng/pkgs/container/seerrng%2Fseerr-chart).
...
```bash
docker buildx imagetools inspect ghcr.io/snapetech/seerrng/seerr-chart:0.1.0 --format '{{json .Manifest.Digest}}' | tr -d '"'
```
  </TabItem>
...
```bash
skopeo inspect docker://ghcr.io/snapetech/seerrng/seerr-chart:0.1.0 --format '{{.Digest}}'
```
  </TabItem>
</Tabs>
...
```bash
cosign verify ghcr.io/snapetech/seerrng/seerr-chart@sha256:abcd1234... \
  --certificate-identity "https://github.com/snapetech/seerrng/.github/workflows/helm.yml@refs/heads/main" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```

:::info Successful Verification Example
Verification for `ghcr.io/snapetech/seerrng/seerr-chart@sha256:abcd1234...`
...
```
https://github.com/snapetech/seerrng/.github/workflows/helm.yml@refs/heads/main
```
...
```bash
DIGEST=$(docker buildx imagetools inspect ghcr.io/snapetech/seerrng/seerr-chart:0.1.0 --format '{{json .Manifest.Digest}}' | tr -d '"')

cosign verify ghcr.io/snapetech/seerrng/seerr-chart@"$DIGEST" \
  --certificate-identity-regexp "https://github.com/snapetech/seerrng/.github/workflows/helm.yml@refs/heads/main" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"

cosign verify-attestation ghcr.io/snapetech/seerrng/seerr-chart@"$DIGEST" \
  --type cyclonedx \
  --certificate-identity-regexp "https://github.com/snapetech/seerrng/.github/workflows/helm.yml@refs/heads/main" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```
...
```bash
DIGEST=$(skopeo inspect docker://ghcr.io/snapetech/seerrng/seerr-chart:0.1.0 --format '{{.Digest}}')
...
- [Seerr GitHub Repository](https://github.com/snapetech/seerrng)
