      ...
      <article className="refreshed-card-surface refreshed-detail-text relative overflow-hidden rounded-xl border border-gray-700 p-3 shadow-lg shadow-gray-950/20">
        ...
        <div className="relative z-10">
              ...
              <div className="mt-4 grid min-w-0 flex-1 grid-cols-1 card:grid-cols-3">
                <div className="min-w-0 card:col-span-2 card:pr-3">
                  <dl className="grid min-w-0 grid-cols-[max-content_minmax(0,1fr)] content-start gap-x-3 gap-y-0.5 text-xs leading-4 card:grid-cols-[max-content_0.75rem_6rem_0.75rem_1px_0.75rem_minmax(0,1fr)] card:gap-x-0">
                    ...
                    <dd className="m-0 truncate card:col-start-3 card:row-start-4">
                      {data.publisher || unavailable}
                    </dd>

                    <div className="hidden bg-gray-600 card:col-start-5 card:row-span-4 card:row-start-1 card:block" />
                    <div className="col-span-2 mt-2 grid min-w-0 grid-cols-[max-content_minmax(0,1fr)] content-start gap-x-3 gap-y-0.5 border-t border-gray-600 pt-2 card:col-span-1 card:col-start-7 card:row-span-4 card:row-start-1 card:mt-0 card:border-t-0 card:pt-0">
                    ...
                    <dt className="mt-0.5 font-medium text-gray-100 card:col-start-1 card:row-start-5">
                      {intl.formatMessage(messages.genres)}:
                    </dt>
                    <dd
                      className="m-0 mt-0.5 min-w-0 break-words card:col-span-5 card:col-start-3 card:row-start-5"
          ...
          <section className="refreshed-inset-surface mt-[5px] rounded-lg border border-gray-700 p-3">
            ...
            <div className="refreshed-detail-text-muted prose prose-sm mt-4 max-w-none text-sm leading-5 prose-p:my-0 prose-p:leading-5 prose-a:text-indigo-300 prose-a:underline prose-a:hover:text-indigo-200">
              <ReactMarkdown
                skipHtml
