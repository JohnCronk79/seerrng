...
const BookFormatBadge = ({
  ...
  const variantClasses = {
    card: 'poster-control poster-control-book-format max-w-full border font-semibold shadow-md',
    compact:
      'inline-flex max-w-full items-center gap-1 rounded-md border border-amber-500/70 bg-amber-700/35 px-2 py-1 text-[11px] font-semibold leading-none text-amber-50',
    inline:
