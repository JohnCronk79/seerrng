          ...
          <div className="relative">
            ...
            {canEditAvatar && (
              <>
                ...
                <button
                  type="button"
                  className="app-button app-button-default absolute -bottom-2 left-1/2 -translate-x-1/2 rounded-full px-2 py-0.5 text-xs shadow disabled:cursor-wait disabled:opacity-70"
